  ...
  describe('parseDiff', () => {
    ...
    it('passes context lines through to git diff', async () => {
      ...
      expect(response).toEqual({
        ...
        files: [],
        isEmpty: true,
        baseCommitish: 'abcdef1234567890abcdef1234567890abcdef12',
        targetCommitish: '1234567890abcdef1234567890abcdef12345678',
    ...
    it('uses merge-base when baseMode is merge-base', async () => {
      ...
      expect(response).toEqual({
        ...
        files: [],
        isEmpty: true,
        baseCommitish: 'fedcba9876543210fedcba9876543210fedcba98',
        targetCommitish: '.',
